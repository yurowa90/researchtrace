...
type Report={site:SchoolSite;storage:"legacy"|"migrating"|"google";identitySchemaReady:boolean;currentIdentityId:number|null;accounts:Account[];identities:Link[];events:{id:number;identityId:number;action:string;actorId:number;targetUserId:number|null;note:string;createdAt:string}[]};
