...
export function WorkImportView({ data, students, selectedStudentId, onSelect, onRecords, onImport, busy }: {
  ...
  const requestText = workRequestText(student, readiness.classroom, data.records, materials);
  ...
  const review = () => {
    ...
    if (profile) {
      ...
      errors.push(...libraryReferenceIssues(profile, data.referenceMaterials));
